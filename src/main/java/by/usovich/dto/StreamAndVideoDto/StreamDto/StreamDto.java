...
public class StreamDto {
    ...
    public StreamDto(String titel, String name, String refVideo, String refImage, String data) {
        this._titel = titel;
        this._name = name;
    ...
    public StreamDto(String _id, String _titel, String _name, String _refVideo, String _refImage, String _data) {
        this._id = _id;
        this._titel = _titel;
        this._name = _name;
