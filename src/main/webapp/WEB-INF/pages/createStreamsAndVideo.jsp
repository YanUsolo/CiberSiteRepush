...
<html>
<head>
    <title>Create Stream/Video</title>
...
<div class="page-container personal-page-background">
    <div class="wrapper">
        ...
        <div class="registration-block">
            <h2>Создание стимов и видео</h2>
            <form id="registration-form" class="registration-form" action="createSteamOrVideo" method="post">
                <fieldset>
                    <select name="type">
                ...
                <fieldset>
                    <input name="name" type="text" size="40" placeholder="Название">
                </fieldset>
                <fieldset>
                    <input name="refVideo" type="text" size="40" placeholder="Ссылка на видео">
                </fieldset>
                <fieldset>
                    <input name="refImage" type="text" size="40" placeholder="Ссылка на картинку">
                </fieldset>
